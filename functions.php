...
$papercuts_themever = "1.2.4";									//Theme version
...
require_once ($papercuts_fe_path . 'wp_bootstrap_navwalker.php');	 	 // Bootstrap navwalker  
...
function papercuts_scripts_styles() {
    ...
    wp_enqueue_style( 'papercuts-bootstrap-style', get_template_directory_uri() . '/css/bootstrap.css' );
